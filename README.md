...
We propose an Multiplex Graph **P**rompt **L**earning and **A**ttentive **F**usion for Event Graph
Completion (**PLAF**) model for the EGC task to learn event representations interactively among each homogeneous graphs
and adopt a kind of dual graph prompt learning for missing relation prediction.
